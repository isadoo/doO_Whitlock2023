...
# for the asexual simulations 111, 112
...
EXPERIMENT_DIR_COV   = '/scratch/st-whitlock-1/isa/csvs1.1.1' 
...
#Correlated
pre_DF_T = {'Environment': np.full(len(COR_G11_T), "Correlated_OTAL")}      
Correlated_111_T = pd.DataFrame(GMAT_DFer('COR',pre_DF_T,'T'))

pre_DF_P = {'Environment': np.full(len(COR_G11_P), "Correlated_PLEIOTROPY")}      
Correlated_111_P = pd.DataFrame(GMAT_DFer('COR',pre_DF_P,'P'))

pre_DF_LD = {'Environment': np.full(len(COR_G11_LD), "Correlated_LD")}      
Correlated_111_LD = pd.DataFrame(GMAT_DFer('COR',pre_DF_LD,'LD'))

Correlated_111_T.to_csv('Correlated_111_T.csv')
Correlated_111_P.to_csv('Correlated_111_P.csv')
Correlated_111_LD.to_csv('Correlated_111_LD.csv')
...
Uncorrelated_112_T.to_csv('Uncorrelated_112_T.csv')
Uncorrelated_112_P.to_csv('Uncorrelated_112_P.csv')
Uncorrelated_112_LD.to_csv('Uncorrelated_112_LD.csv')
